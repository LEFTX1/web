<template>
    <div class="imguload-box">
        <div class="imgbox" v-if="serverData.url && props.showimg">
            <img :src="serverData.url"/>
        </div>
        <div class="imgbox" v-if="!serverData.url && modelValue && props.showimg">
            <img :src="modelValue"/>
        </div>
        <el-upload
...
<script setup>
  ...
  const uploadOptions = reactive({
    action:apiPath.value+"/"+props.type+"/upload/file",
    name:"file",
    method:"post",
